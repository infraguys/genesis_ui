      ...
      branches: [
        ...
        StatefulShellBranchData.$branch(
          routes: [
            GoRouteData.$route(
              path: '/nodes',
              factory: $NodesPageRouteExtension._fromState,
              routes: [
                GoRouteData.$route(
                  path: ':nodeUuid',
                  factory: $NodePageRouteExtension._fromState,
                ),
              ],
            ),
          ],
        ...
        StatefulShellBranchData.$branch(
          routes: [
            GoRouteData.$route(
              path: '/vpns',
              factory: $VpnsPageRouteExtension._fromState,
            ),
          ],
        ),
      ],
...
extension $UserPageRouteExtension on UserPageRoute {
  ...
  String get location => GoRouteData.$location(
        '/users/${Uri.encodeComponent(userUuid)}',
      );
...
extension $NodesPageRouteExtension on NodesPageRoute {
  static NodesPageRoute _fromState(GoRouterState state) =>
...
extension $NodePageRouteExtension on NodePageRoute {
  static NodePageRoute _fromState(GoRouterState state) => NodePageRoute(
        nodeUuid: state.pathParameters['nodeUuid']!,
      );

  String get location => GoRouteData.$location(
        '/nodes/${Uri.encodeComponent(nodeUuid)}',
      );
...
extension $VpnsPageRouteExtension on VpnsPageRoute {
  static VpnsPageRoute _fromState(GoRouterState state) => const VpnsPageRoute();
