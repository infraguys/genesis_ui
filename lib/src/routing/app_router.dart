...
import 'package:genesis/src/features/organizations/presentation/pages/organization_details_page/organization_details_page.dart';
import 'package:genesis/src/features/organizations/presentation/pages/organization_list_page/organization_list_page.dart';
import 'package:genesis/src/features/projects/presentation/pages/attach_project_page/attach_project_page.dart';
import 'package:genesis/src/features/projects/presentation/pages/create_project_page/create_project_page.dart';
import 'package:genesis/src/features/projects/presentation/pages/project_details_page/project_details_page.dart';
import 'package:genesis/src/features/projects/presentation/pages/project_list_page/project_list_page.dart';
import 'package:genesis/src/features/roles/presentation/pages/attach_roles_page/attach_roles_page.dart';
import 'package:genesis/src/features/roles/presentation/pages/create_role_page/create_role_page.dart';
import 'package:genesis/src/features/roles/presentation/pages/role_details_page/role_details_page.dart';
import 'package:genesis/src/features/roles/presentation/pages/role_list_page/role_list_page.dart';
import 'package:genesis/src/features/bootstrap/presentation/blocs/server_setup_cubit/domain_setup_cubit.dart';
import 'package:genesis/src/features/bootstrap/presentation/pages/splash_screen/splash_screen.dart';
...
class _GoRouterAuthListenable extends ChangeNotifier {
  _GoRouterAuthListenable(BuildContext context) {
    ...
    notifyListeners();
    _subscription = bloc.stream.listen((state) => notifyListeners());
  }
