...
part 'users_feat_user_dto.g.dart';

@JsonSerializable(createToJson: false, constructor: '_')
class UsersFeatUserDto implements IDto<User> {
  UsersFeatUserDto._({
    required this.uuid,
  ...
  factory UsersFeatUserDto.fromJson(Map<String, dynamic> json) {
    final modifiedJson = Map.of(json);
    modifiedJson['username'] ??= json['name'];
    return _$UsersFeatUserDtoFromJson(modifiedJson);
  }
