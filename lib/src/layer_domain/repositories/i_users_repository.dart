...
abstract interface class IUsersRepository {
  ...
  Future<void> deleteUser(UserUUID uuid);

  Future<User> changeUserPassword(ChangeUserPasswordParams params);

  Future<User> resetUserPassword();

  Future<User> confirmEmail(UserUUID params);

  Future<User> forceConfirmEmail(UserUUID params);

  Future<User> getUser(UserUUID uuid);
}
