...
final class CreateRoleBindingUseCase {
  CreateRoleBindingUseCase(this._repository);

  final IRoleBindingsRepository _repository;

  Future<void> call(CreateRoleBindingParams params) async {
    _repository.createRoleBinding(params);
  }
}
